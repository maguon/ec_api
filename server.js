...
const createServer=()=>{
    ...
    server.get('/api/user/:userId/prodStoreWarning', product.queryProdStoreWarning);
    ...
    server.get('/api/user/:userId/orderItemProd.csv', orderItemProd.queryItemProdCsv);
    ...
    server.get('/api/user/:userId/orderTypeStat' ,order.queryTypeStat);
    server.get('/api/user/:userId/orderPartTypeStat' ,order.queryPartTypeStat);
    ...
    server.post({path:'/api/user/:userId/clientAgent/:clientAgentId/payment',contentType: 'application/json'}, payment.addCustomerAgentPayment);
